    ...
    <div className="absolute inset-0 bg-[#080808] flex flex-col text-white">
      ...
      {finalUrl && (
        ...
        <div className="flex-1 flex items-center justify-center p-6">
          <div className="relative shadow-2xl rounded-lg overflow-hidden max-h-[62vh]">
            <img src={finalUrl} alt="仿色結果" className="max-w-full max-h-[62vh] object-contain allow-callout" />
            <div className="absolute inset-0 pointer-events-none ring-1 ring-white/10 rounded-lg" />
          </div>
        </div>
